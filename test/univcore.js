...
/* ────────── 전남대학교 · 학생부교과(일반) 일괄선발 ────────── */
    ...
    gachonS: {
      ...
      careerAreaLimited: true,
      /* 교과 제한 없이 공통과목·일반선택과목 전체를 반영한다.
         두 유형 모두 석차등급으로 계산하므로, 석차등급이 없는 과목
         (체육·예술 일반선택은 성취도만, 교양은 이수 P만)은 convert에서 자연히 빠지고
         석차등급이 나오는 정보·제2외국어Ⅰ·한문Ⅰ은 그대로 들어온다. */
      areas: ['국어', '수학', '영어', '사회', '과학', '체예', '기타'],
      areaNote: '교과 제한 없음 — 공통과목 · 일반선택과목 전체 (석차등급이 산출된 과목만)',
